...
Dispute.create(client_id: rand(1..4) , dispute_category: 1, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 2, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 3, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 4, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 5, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 6, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 1, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 2, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 3, dispute_info: Faker::TvShows::Suits.quote)
Dispute.create(client_id: rand(1..4) , dispute_category: 4, dispute_info: Faker::TvShows::Suits.quote)
